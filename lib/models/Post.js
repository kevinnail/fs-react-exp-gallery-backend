...
module.exports = class Post {
  ...
  static async postNewPost(
    ...
    const { rows } = await pool.query(
      'INSERT INTO gallery_posts (title, description, image_url, category, price, author_id, public_id, add_imgs) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *',
      [
        title,
        description,
        image_url,
