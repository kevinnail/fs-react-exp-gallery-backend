...
module.exports = class Post {
  ...
  static async postNewPost(
    ...
    const { rows } = await pool.query(
      'INSERT INTO gallery_posts (title, description, image_url, category, price, author_id, public_id) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
      [title, description, image_url, category, price, author_id, public_id]
    );
  ...
  static async addGalleryImages(post_id, image_urls, image_public_ids) {
    const insertQuery = `
      INSERT INTO gallery_imgs (post_id, img_url, public_id)
      VALUES ($1, $2, $3)
      RETURNING *;
    `;
